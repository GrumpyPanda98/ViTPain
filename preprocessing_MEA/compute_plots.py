...
from utils import create_raw_object, apply_filters, plot_psd, plot_evoked_responses
...
for experiment_folder in tqdm(experiment_folders, position=0, desc = 'Experiment', leave=True):
    ...
    # Plot and save evoked responses
    plot_evoked_responses(raw, events, event_id, folder)
